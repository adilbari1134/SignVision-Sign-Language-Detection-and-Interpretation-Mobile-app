...
import 'package:sign_vision/screens/eat.dart'; // Updated import to point to Eat screen
...
class _DrinkState extends State<Drink> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/activities/drink.mp4')
      ..initialize().then((_) {
        setState(() {});
        _controller.play();
      });
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => CameraScreen(nextScreen: Eat())));
                  },
                  child: Text(
                    "Practice",
