...
import 'package:sign_vision/screens/ketchup.dart'; // Updated import to point to Ketchup screen
...
class _EatState extends State<Eat> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/activities/eat.mp4')
      ..initialize().then((_) {
        setState(() {});
        _controller.play();
      });
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) =>
                            CameraScreen(nextScreen: Ketchup())));
                  },
                  child: Text(
                    "Practice",
