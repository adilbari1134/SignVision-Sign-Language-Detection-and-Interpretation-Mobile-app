...
import 'package:sign_vision/screens/seeyoulater.dart';
...
class _NothingState extends State<Nothing> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/cphrases/nothing.mp4')
      ..initialize().then((_) {
        setState(() {});
        _controller.play();
      });
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) =>
                            CameraScreen(nextScreen: Seeyoulater())));
                  },
                  child: Text(
                    "Practice",
