...
import 'package:sign_vision/screens/green.dart'; // Updated import to point to Green screen
...
class _BlueState extends State<Blue> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/sentences/blue.mp4')
      ..initialize().then((_) {
        setState(() {});
        _controller.play();
      });
                  ...
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => CameraScreen(
                            nextScreen:
                                Green()))); // Updated to navigate to Green screen
                  },
                  child: Text(
                    "Practice",
