...
import 'package:sign_vision/screens/ok.dart';
import 'package:video_player/video_player.dart';

class Howareyou extends StatefulWidget {
  const Howareyou({super.key});
...
class _HowareyouState extends State<Howareyou> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/greetings/howareyou.mp4')
      ..initialize().then((_) {
        setState(() {});
        _controller.play();
      });
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => CameraScreen(nextScreen: Ok())));
                  },
                  child: Text(
                    "Practice",
