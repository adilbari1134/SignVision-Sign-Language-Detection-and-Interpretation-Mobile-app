...
import 'package:sign_vision/screens/blue.dart'; // Updated import to point to Blue screen
...
class _YesState extends State<Yes> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/activities/yes.mp4')
      ..initialize().then((_) {
        setState(() {});
        _controller.play();
      });
                  ...
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => CameraScreen(
                            nextScreen:
                                Blue()))); // Updated to navigate to Blue screen
                  },
                  child: Text(
                    "Practice",
