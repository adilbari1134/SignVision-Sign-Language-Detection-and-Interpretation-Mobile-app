...
import 'package:sign_vision/screens/nothing.dart';
import 'package:video_player/video_player.dart';

class Nicetomeetyou extends StatefulWidget {
  const Nicetomeetyou({super.key});
...
class _NicetomeetyouState extends State<Nicetomeetyou> {
  ...
  void initState() {
    super.initState();
    _controller =
        VideoPlayerController.asset('assets/cphrases/nicetomeetyou.mp4')
          ..initialize().then((_) {
            setState(() {});
            _controller.play();
          });
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) =>
                            CameraScreen(nextScreen: Nothing())));
                  },
                  child: Text(
                    "Practice",
