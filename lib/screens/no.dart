...
import 'package:sign_vision/screens/sandwich.dart'; // Updated import to point to Sandwich screen
...
class _NoState extends State<No> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/activities/no.mp4')
      ..initialize().then((_) {
        setState(() {});
        _controller.play();
      });
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) =>
                            CameraScreen(nextScreen: Sandwich())));
                  },
                  child: Text(
                    "Practice",
