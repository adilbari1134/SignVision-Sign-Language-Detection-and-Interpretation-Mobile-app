...
import 'package:sign_vision/screens/red.dart'; // Updated import to point to Red screen
...
class _GreenState extends State<Green> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/sentences/green.mp4')
      ..initialize().then((_) {
        setState(() {});
        _controller.play();
      });
                  ...
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => CameraScreen(
                            nextScreen:
                                Red()))); // Updated to navigate to Red screen
                  },
                  child: Text(
                    "Practice",
